...
%OutputPath = './Results/Improved Visibility of Road Scene Images under Heterogeneous Fog/';
...
tic;
    ...
    res2=nbpcpa(img,sv,0.95,0.5,1,1.3,205,300); %Improved Visibility of Road Scene Images under Heterogeneous Fog
